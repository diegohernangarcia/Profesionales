<html>
	<head>
		<script Language="JavaScript">
				function validar(formulario) {
					...
					{
						alert("Por favor no deje en blanco la institucion a agregar");
	...
	<body>
	<form method="POST" name="registro" onSubmit="return validar(this)" action="AgregarInstitucion.php">
    <BODY bgcolor="#cccccc">
		...
		<table border="2" cellpadding="3" cellspacing="0" align="center" valign="center">
			<tr> <th colspan="3">Agregar Institucion</th> </tr>
			<tr> <td> Institucion <input type="text" name="Institucion" id="Institucion"> </td>
		...
		<body  onload="document.getElementById('Institucion').focus()">  
	</body>
</html>
