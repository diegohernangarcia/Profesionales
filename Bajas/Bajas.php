 ...
 <?php 
	...
	$contador=0;
	$idborrar=mysql_result($hacerconsulta,$contador,"Id");
	...
	//require ("../Funciones/Funciones.php");
	session_start();
	$_SESSION["borrar"] = "DELETE FROM registroprofesionales WHERE Id='".$idborrar."'";	
	?>
    
    <!-- PRESENTACION DE INFO EN PANTALLA -->
   
 <body>
		<form name="f_prof" id="f_prof" action="Borrar.php" method="post">
		...
		<HR>
		<CENTER>
       <input type="submit" value="Borrar" name="ok" id="ok">
